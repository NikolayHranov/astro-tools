...
def select_light_directory():
    ...
    printtk(selected_light_directory)
...
def select_dark_directory():
    ...
    printtk(selected_dark_directory)
...
def select_darkflat_directory():
    ...
    printtk(selected_darkflat_directory)
...
def select_flat_directory():
    ...
    printtk(selected_flat_directory)
...
def select_end_directory():
    ...
    printtk(selected_end_directory)
